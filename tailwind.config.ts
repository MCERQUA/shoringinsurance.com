  ...
  theme: {
    extend: {
      colors: {
        ...
        sand: "#EBF0F4",
        white: "#FFFFFF",
        // Brand ramp was navy; now rust (Josh: no blue). #9A3F18: 6.8:1 on white.
        clay: {
          DEFAULT: "#9A3F18",
          dark: "#6B2F14",
          light: "#B4460F",
      ...
      backgroundImage: {
        "sunrise-bands":
          "linear-gradient(180deg, #F6F8FA 0%, #EBF0F4 40%, #FBEFE6 70%, #F6F8FA 100%)",
        "warm-radial":
          "radial-gradient(circle at 30% 20%, rgba(180,70,15,0.10) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(224,120,32,0.08) 0%, transparent 55%)",
      ...
      boxShadow: {
        warm: "0 10px 40px -15px rgba(154, 63, 24, 0.22), 0 4px 12px -6px rgba(14, 24, 36, 0.08)",
        "warm-lg": "0 30px 70px -20px rgba(154, 63, 24, 0.28), 0 10px 30px -10px rgba(14, 24, 36, 0.10)",
        card: "0 2px 8px -2px rgba(14, 24, 36, 0.06), 0 1px 3px -1px rgba(14, 24, 36, 0.04)",
        "card-hover": "0 20px 50px -15px rgba(154, 63, 24, 0.22), 0 8px 20px -8px rgba(14, 24, 36, 0.10)",
        arch: "inset 0 -8px 30px -10px rgba(154, 63, 24, 0.10)",
      },
      keyframes: {
